// MESSAGE POLY_START support class
...
/**
 * @brief POLY_START message
 *
 *  Start mission defined by polynomial trajectory generator
 */
struct POLY_START : mavlink::Message {
    static constexpr msgid_t MSG_ID = 273;
    static constexpr size_t LENGTH = 6;
    static constexpr size_t MIN_LENGTH = 6;
    static constexpr uint8_t CRC_EXTRA = 45;
    static constexpr auto NAME = "POLY_START";
